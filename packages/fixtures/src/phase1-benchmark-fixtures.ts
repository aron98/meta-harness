...
export type Phase1BenchmarkFixture = {
  id: string;
  title: string;
  prompt: string;
...
export type Phase1BenchmarkCatalog = readonly DeepReadonly<Phase1BenchmarkFixture>[];

export const phase1BenchmarkFixtures: Phase1BenchmarkCatalog = freezeDeep([
  {
    id: 'phase1-explore-monorepo-layout',
  ...
  {
    id: 'phase1-verify-release-build',
  ...
  {
    id: 'phase1-implement-retry-logic',
  ...
  {
    id: 'phase1-explain-verification-failure',
